...
# Location of host truth catalog
host_truth_cat=$6
...
python $gcr_catsim_dir/bin.src/generateInstCat.py \
    ...
    --fov $fov --ids $visit_id --agn_threads 2 --out_dir $out_dir
...
python create_lensed_host_ic.py \
    --obs_db /global/projecta/projectdirs/lsst/groups/SSim/DC2/minion_1016_desc_dithered_v4.db \
    --obs_id $visit_id --fov $fov --host_truth_cat $host_truth_cat \
    --fits_stamp_dir $SCRATCH/outputs --file_out $out_dir/lensed_hosts_$visit_id.txt