...
def load_in_data_sne():
    ...
    conn = sql.connect(os.path.join(data_dir,'example.db'))
...
def create_cats_sne(index, hdu_list, ahb_list):
    ...
    twinkles_ID = ahb['twinkles_system'][index]
    print('woof', twinkles_ID)
    
    UID_lens = ahb['unique_id'][index]
    ...
    srcsP_disk = {'ys1'          : ys1,
                  'ys2'          : ys2,
                  'mag_src_d_u'  : mag_src_d_u,
                  'mag_src_d_g'  : mag_src_d_g,
                  'mag_src_d_r'  : mag_src_d_r,
                  'mag_src_d_i'  : mag_src_d_i,
                  'mag_src_d_z'  : mag_src_d_z,
                  'mag_src_d_y'  : mag_src_d_y,
                  'Reff_src'     : Reff_src_d,
                  'qs'           : qs_d,
                  'phs'          : phs_d,
                  'ns'           : ns_d,
    ...
    srcsP_bulge = {'ys1'          : ys1,
                   'ys2'          : ys2,
                   'mag_src_b_u'  : mag_src_b_u,
                   'mag_src_b_g'  : mag_src_b_g,
                   'mag_src_b_r'  : mag_src_b_r,
                   'mag_src_b_i'  : mag_src_b_i,
                   'mag_src_b_z'  : mag_src_b_z,
                   'mag_src_b_y'  : mag_src_b_y,
                   'Reff_src'     : Reff_src_b,
                   'qs'           : qs_b,
                   'phs'          : phs_b,
                   'ns'           : ns_b,
